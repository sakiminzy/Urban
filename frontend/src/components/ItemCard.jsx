...
function ItemCard({ item }) {
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-3xl border border-white/80 bg-white shadow-xl shadow-emerald-950/5 transition duration-300 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-emerald-950/10 dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="flex flex-1 flex-col p-6">
        <h2 className="mt-1 text-xl font-black text-slate-950 dark:text-slate-50">{item.title}</h2>
