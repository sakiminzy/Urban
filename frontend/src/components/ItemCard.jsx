...
function ItemCard({ item }) {
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-3xl border border-white/80 bg-white shadow-xl shadow-emerald-950/5 transition duration-300 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-emerald-950/10">
      <div className="relative overflow-hidden">
        ...
        <span className="absolute left-4 top-4 badge bg-white/90 text-harvestGreen shadow-sm">
          {item.category}
        </span>
      </div>
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <div className="mt-5 grid gap-2 rounded-2xl bg-slate-50 p-4">
          ...
          <p className="text-sm font-medium text-slate-500">{item.availability}</p>
        </div>
